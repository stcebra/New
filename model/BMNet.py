...
class BMNet(nn.Module):
    ...
    def forward(self, x, time=0.5, train=False):
        im1 = x[:, :3, :, :] # I1
        im2 = x[:, 3:, :, :] # I0


        c11 = self.conv1b(self.conv1aa(self.conv1a(im1))) # level1
        c21 = self.conv1b(self.conv1aa(self.conv1a(im2))) # level1
        c12 = self.conv2b(self.conv2aa(self.conv2a(c11))) # level2
        c22 = self.conv2b(self.conv2aa(self.conv2a(c21))) # level2
        c13 = self.conv3b(self.conv3aa(self.conv3a(c12))) # level3
        c23 = self.conv3b(self.conv3aa(self.conv3a(c22))) # level3
        c14 = self.conv4b(self.conv4aa(self.conv4a(c13))) # level4
        c24 = self.conv4b(self.conv4aa(self.conv4a(c23))) # level4
        c15 = self.conv5b(self.conv5aa(self.conv5a(c14))) # level5
        c25 = self.conv5b(self.conv5aa(self.conv5a(c24))) # level5
        c16 = self.conv6b(self.conv6a(self.conv6aa(c15))) # level6
        c26 = self.conv6b(self.conv6a(self.conv6aa(c25))) # level6

        bicorr6 = self.bilateral_corr6(c16, c26, torch.zeros(c16.size(0), 2, c16.size(2), c16.size(3)).cuda(), time)
        #bicorr6 = self.bilateral_corr6(c16, c26, torch.zeros(c16.size(0), 2, c16.size(2), c16.size(3)), time)
