...
def main():
    ...
    for epoch in range(epochs):
        ...
        for step, data in enumerate(train_bar):
            ...
            F_0_1 = net(F.interpolate(torch.cat((I0, I1), dim=1), (256, 448), mode='bilinear'), time=0, train=False) * 2.0
            F_1_0 = net(F.interpolate(torch.cat((I0, I1), dim=1), (256, 448), mode='bilinear'), time=1, train=False) * (-2.0)
            BM = net(F.interpolate(torch.cat((I0, I1), dim=1), (256, 448), mode='bilinear'), time=0.5, train=False)
